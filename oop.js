...
function personFromPersonStore(name, age) {
  ...
  Object.defineProperty(this, 'sayHi', function(){
    console.log('Hi!')
  })
  obj.name  = name;
  obj.age = age;
...
//saves it to a property by the same name. PersonClass should also have a method called greet that logs the string 'hello'. 
...
/*** CHALLENGE 2 of 3 ***/
//Create a class DeveloperClass that creates objects by extending the PersonClass class. In addition to having a name property 
//and greet method, DeveloperClass should have an introduce method. When called, introduce should log the string 'Hello World, 
//my name is [name]'. 
